...
const StoreorderList = () => {
  ...
  useEffect(() => {
    axios.get("https://superb-grocery-app.herokuapp.com/storeorder/").then((response) => {
  ...
  /* const deleteProduct = (id) => {
    axios.delete("https://superb-grocery-app.herokuapp.com/products/" + id).then((response) => {
...
/* 
  const onSubmit = () => {
    axios.post("https://superb-grocery-app.herokuapp.com/products/add", Product);
  };
