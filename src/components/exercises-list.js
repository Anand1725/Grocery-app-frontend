...
const ExerciseList = () => {
  ...
  useEffect(() => {
    axios.get("https://superb-grocery-app.herokuapp.com/exercises/").then((response) => {
  ...
  const deleteExercise = (id) => {
    axios.delete("https://superb-grocery-app.herokuapp.com/exercises/" + id).then((response) => {
